      ...
      <Section yPadding="pt-16 pb-24 sm:pt-20 sm:pb-32">
        <HeroOneButton
          title={
            <>
              {'一款有温度的\n'}
              <span className="bg-gradient-to-r from-primary-600 to-primary-400 bg-clip-text text-transparent">「小而美工具」</span>
            </>
          }
          description={AppConfig.description}
        />
        <div className="mx-auto mt-16 max-w-md animate-scale-in" style={{ animationDelay: '0.6s' }}>
          <div className="group relative overflow-hidden rounded-3xl shadow-xl ring-1 ring-gray-900/5 transition-all duration-500 hover:shadow-2xl hover:shadow-primary-500/10 hover:-translate-y-1">
